...
$datosconsulta['REPRESENTANTE_LEGAL']='';
                        if ($respuesta['Respuesta'] == '' || $datosconsulta['PASSWORD'] == '') {
                            ...
                            if ($ver = $this->ion_auth->login($correo, $contraseña, $remember, $datosconsulta)) {
                                ...
                                if ($ver['Respuesta'] == 4) {
                                    ...
                                    redirect(base_url("index.php/auth/login1"));
                                } else {
    ...
    function change_password()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($change) {
                ...
                redirect(base_url('index.php/auth/change_password'), 'refresh');
            }
        }
    }
    ...
    function forgot_password()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if (empty($identity)) {
                ...
                redirect(base_url("index.php/auth/forgot_password"), 'refresh');
            }
            ...
            if ($forgotten) {
                ...
                redirect(base_url("index.php/auth/login"), 'refresh'); //we should display a confirmation page here instead of the login page
            } else {
            ...
            if ($this->form_validation->run() == false) {
                ...
                if ($this->_valid_csrf_nonce() === FALSE || $user->IDUSUARIO != $this->input->post('user_id')) {
                    ...
                    if ($change) {
                        ...
                        $this->session->set_flashdata('message', $this->ion_auth->errors());
                        redirect(base_url('index.php/auth/reset_password/') . $code, 'refresh');
                    }
                }
            }
        } else {
