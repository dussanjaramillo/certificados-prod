                    ...
                    <td>
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input aria-hidden="true" type="text" class="form-control" name="identity" id="identity"
                                   placeholder="Usuario" value="<?php if ($correo != "") {
                                echo $correo;
                            } else {
                                echo "";
                            } ?> " readonly>
                    ...
                    <td autocomplete="off">
                        ...
                        <div class="input-group mb-2" autocomplete="off">
                            <div class="input-group-prepend" autocomplete="off">
                                <div class="input-group-text"><i class="fa fa-key prefix" aria-hidden="true"
                        ...
                        <div class="kTNrif" jsname="cyzLac" aria-live="assertive" style="color: red;">Utilizar ocho
                            caracteres como mínimo
                            maximo 15, con una combinación de letras, números y símbolos, sin espacios
                        </div>
                    </td>
                ...
                <tr HEIGHT="60">
                    ...
                    <td>
                        ...
                        <div id="o6cuMc" class="o6cuMc" style="display: none; color: #d93025; " jsname="cyzLac"
                             aria-live="assertive">Estas contraseñas no coinciden; inténtalo de nuevo.
                        </div>
                        <div id="pruebas" class="pruebas" style="display: none; color: #d93025; " jsname="cyzLac"
                             aria-live="assertive">No cumple con las condiciones de Seguridad.
                        </div>
                        <div id="pruebas1" class="pruebas1" style="display: none; color: #d93025; " jsname="cyzLac"
                             aria-live="assertive">Diligencie Los Campo Vacios.
                        </div>
                    </td>
                </tr>
                <tr>
