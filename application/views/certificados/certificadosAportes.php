...
<div class="center-form-large " style=" width:70%; ">
    ...
    <div class="p-3 col-sm-12 bg-light text-dark ">
        ...
        <form id="form1" action="<?= base_url('index.php/iniciocertificados/imprimir'); ?>" method="post"
              onsubmit="return confirmar()">
            <input type="hidden" name="vista" id="vista" value="<?php echo $vista; ?>">
            <input type="hidden" name="name_reporte" id="name_reporte" value="<?php echo $titulo; ?>"><input
                    type="hidden" name="vista" id="vista" value="<?php echo $vista; ?>">
                ...
                <table id="validar" class="table table-bordered table-striped">
                    ...
                    <tr style="display:block; visibility:visible">
                        ...
                        <td style="width: 100%" align="center">
                            <?php /*echo $input;*/
                            if (($input != 8 && $input != 15 && $input != 12) || ($input == 9 && $input == 10)) { ?>
                            <strong><i>Nit/Empresa: <br> <i></i></i></strong><i><i>
                                    <input type="text" id="empresa" class="text-center" name="empresa" size="29"
                                           style="width: 196px" value="<?php echo $nit; ?>" disabled>
                                    <br>
                        <td width="21%">
                        </td>
                    </tr>
                        ...
                        <tr style="display:block; visibility:visible">
                            ...
                            <td style="width: 100%" align="center">
                                <strong><i>N° Ticket ID: <br><i></i></i></strong><i><i>
                                        <input type="text" id="Ntickei" name="Ntickei" size="29"
                                               style="width: 196px"><img id="preloadmini"/>
                                        <br>
                            <td width="21%">
                            </td>
                        </tr>
                        ...
                        <tr style="display:block; visibility:visible">
                            ...
                            <td style="width: 100%" align="center">
                                <strong><i> Periodo Pago <br><i></i></i></strong><i><i>
                                        <input type="text" readonly id="transacion" name="transacion" size="29"
                                               style="width: 196px" value="<?php echo date('Y') . '-' . date('n') ?>">
                        ...
                        <tr style="display:block; visibility:visible">
                            ...
                            <td style="width: 100%" align="center">
                                <strong><i> Liquidaci&oacute;n / Resoluci&oacute;n <br> <i></i></i></strong><i><i>
                                        <input type="text" name="num_proceso" id="num_proceso" size="29"
                                               style="width: 196px">
                                        <br>
                            <td width="21%">
                            </td>
                        ...
                        <tr style="display:block; visibility:visible">
                            ...
                            <td style="width: 100%" align="center">
                                <strong><i> Periodo <br><i></i></i></strong><i><i>
                                        <input type="text" class="periodo" readonly id="periodo" name="periodo"
                                               size="29" style="width: 196px"
                                               value="<?php echo date('Y') . '-' . date('n') ?>">
                                        <br>
                            <td width="21%">
                            </td>
                        </tr>
...
<script>
    ...
    function regresar() {
        // console.log("goo");
        window.location.href = "<?= base_url('index.php/auth/consulta') ?>";
    }
    ...
    $(".periodo").datepicker({
        ...
        buttonImage: '<?= base_url() . "img/calendario.png" ?>',
        buttonImageOnly: true,
        numberOfMonths: 1,
    });
